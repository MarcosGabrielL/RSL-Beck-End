...
public class Post_Stories {
    ...
    public Post_Stories(Long id, String idperson, String texto, String idimagem, String email, String tipo, String hora, String hastags, String local) {
        this.id = id;
