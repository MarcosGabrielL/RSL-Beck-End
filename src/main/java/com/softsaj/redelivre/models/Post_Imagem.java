...
@Entity
@Table(name = "post_imagens")
public class Post_Imagem {
    ...
    public Post_Imagem(Long id, String idperson, String texto, String idimagem, String email, String tipo, String hora, String hastags, String local) {
        this.id = id;
