...
import com.softsaj.redelivre.gibgasVenda.file.FileVenda;
import com.softsaj.redelivre.gibgasVenda.file.FileStorageServiceVenda;
import com.softsaj.redelivre.gibgasVenda.models.Produto;
import com.softsaj.redelivre.gibgasVenda.models.ProdutoDTO;
...
public class ProdutoController {
    ...
    private ProdutoService vs;
      ...
      @Autowired
  private FileStorageServiceVenda storageService;
    ...
    public ResponseEntity<List<ProdutoDTO>> getProdutoDAOByIdVendedor (
       ...
       // }
        ...
        for(Produto p: produtos){
            ...
            List<FileVenda> files = storageService.findByIdProduto(p.getId().toString());
            pdao.setFiles(files); 
            
             System.out.println("Pdao Files"+pdao.getFiles());
            for(FileVenda d: files){
            System.out.println("Files: "+ d.getName());
                    }
            
            List<String> urls = new ArrayList();
            for(FileVenda f: files){
