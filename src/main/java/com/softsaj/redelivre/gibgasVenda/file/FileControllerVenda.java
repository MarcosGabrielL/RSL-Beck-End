...
@RequestMapping("/produtos/file")
public class FileControllerVenda {
  ...
  public ResponseEntity<List<FileVenda>> findByIdProduto(@PathVariable String id) {
     List<FileVenda> files = storageService.findByIdProduto(id);
  ...
  public ResponseEntity<List<FileVenda>> findByIdLoja(@PathVariable String id) {
     List<FileVenda> files = storageService.findByIdVendedor(id);
  ...
  public ResponseEntity<byte[]> getFile(@PathVariable Long id) {
	  FileVenda fileDB = storageService.getFile(id);
